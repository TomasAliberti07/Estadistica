...
root.configure(bg="#ADD8E6")  # Color azul clarito tipo pastel

label_a = tk.Label(root, text="Coeficiente cuadrático:", bg="#ADD8E6", fg="black")
label_a.grid(row=0, column=0, padx=10, pady=10)
entry_a = tk.Entry(root)
entry_a.grid(row=0, column=1, padx=10, pady=10)

label_b = tk.Label(root, text="Coeficiente lineal:", bg="#ADD8E6", fg="black")
label_b.grid(row=1, column=0, padx=10, pady=10)
entry_b = tk.Entry(root)
entry_b.grid(row=1, column=1, padx=10, pady=10)

label_c = tk.Label(root, text="Coeficiente independiente:", bg="#ADD8E6", fg="black")
label_c.grid(row=2, column=0, padx=10, pady=10)
entry_c = tk.Entry(root)
entry_c.grid(row=2, column=1, padx=10, pady=10)

label_intervalo_inicio = tk.Label(root, text="Inicio del intervalo:", bg="#ADD8E6", fg="black")
...
label_intervalo_fin = tk.Label(root, text="Fin del intervalo:", bg="#ADD8E6", fg="black")
...
label_num_rectangulos = tk.Label(root, text="Número de rectángulos:", bg="#ADD8E6", fg="black")
...
boton_calcular = tk.Button(root, text="Calcular", command=obtener_parametros, bg="#ADD8E6", fg="black")
boton_calcular.grid(row=6, column=0, columnspan=2, padx=10, pady=10)

texto_resultado = tk.Text(root, width=40, height=10, bg="#ADD8E6", fg="black")
