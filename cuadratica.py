...
def graficar_funcion(a, b, c, intervalo_inicio, intervalo_fin, num_rectangulos):
    # Ajustar el rango de x_plot para centrarse en el intervalo de interés
    ...
    # Colorear solo la región de interés
    ...
    for i in range(num_rectangulos):
        ...
        plt.bar(xi, max(0, altura), width=ancho, color='blue', alpha=0.3, edgecolor='black', align='edge')
    ...
    plt.ylim(min(y_plot) - 5, max(y_plot) + 5)  # Ajustar según sea necesario
